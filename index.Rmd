...
`sessionInfo()` in R to find out the version of R you have installed. Compare this
version to the latest R release version listed at the **Comprehensive R Archive 
Network (CRAN)**^[**Comprehensive R Archive Network (CRAN).** ...]
